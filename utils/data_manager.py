...
from utils.data import i5Datasets_vit, iCore50, CDDB, iDomainNet
...
class DataManager(object):
    ...
    def get_trsf(self):
        return self.train_trsf, self.test_trsf
    ...
    def _setup_data(self, dataset_name, shuffle, seed):
        ...
        if self.dataset_name not in ['core50', 'domainnet']:
            logging.info(self._class_order)
            # Map indices
