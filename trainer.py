...
def _train(args):
    ...
    for task in range(data_manager.nb_tasks):
        ...
        if nme_accy is not None:
            ...
            nme_forget.append(nme_accy['forget'])
            nme_backward.append(nme_accy['backward'])
            ...
            if task > 0:
                logging.info('NME forget: {}'.format(nme_forget))
                logging.info('NME backward: {}'.format(nme_backward))
        else:
